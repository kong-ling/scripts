...
usw_build_path = "./build/configs/polaris_ppu_multicore_sle_post"
...
ppu_image_path = "lingkong@sccj019906.sc.intel.com:/nfs/site/disks/sc_polaris_emu01/usrs/lingkong/image/18ww50d/"
...
cmd = 'scp %s/ppu_arm*/*.hex %s' % (usw_build_path, ppu_image_path)
print(cmd)
os.system(cmd)
